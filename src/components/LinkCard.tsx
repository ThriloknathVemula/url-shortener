...
export const LinkCard = ({urlDetails, fetchUrls}:any)=>{
    ...
    return <div className="flex flex-row items-center border-solid border-gray-800 p-2 md:p-5 rounded-md border-2 mt-4 justify-between cursor-pointer">
        <div onClick={()=>navigate(`/link/${id}`)} className="flex flex-col items-start gap-1">
